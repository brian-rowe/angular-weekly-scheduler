...
var MultiSliderController = /** @class */ (function () {
    function MultiSliderController($element, $q, endAdjusterService, nullEndWidth) {
        this.$element = $element;
        this.$q = $q;
