    ...
    function FullCalendarDirective() {
        this.link = function (scope, element, attrs, ngModelCtrl) {
            if (attrs.fullCalendar) {
                ngModelCtrl.$validators.fullCalendar = function () {
                    return true;
                };
            }
            else {
