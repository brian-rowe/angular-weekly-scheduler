    ...
    MultiSliderController.prototype.$postLink = function () {
        ...
        if (this.$hoverElement.length) {
            this.element.addEventListener('mousemove', function (e) {
                ...
                var elementOffsetX = _this.getElementOffsetX(_this.$element);
                var left = e.pageX - elementOffsetX - _this.$hoverElement[0].clientWidth / 2;
                var val = _this.pixelToVal(left);
                var updatedLeft;
                var updatedRight;
                if (isDragging) {
                    updatedLeft = _this.$hoverElement.css('left');
                    updatedRight = _this.getSlotRight(val, _this.pixelToVal(e.pageX));
                }
                else {
                    updatedLeft = _this.getSlotLeft(val);
                    updatedRight = _this.config.nullEnds ? _this.getSlotRight(val, val + _this.nullEndWidth) : _this.getSlotRight(val, val + defaultSize);
                }
