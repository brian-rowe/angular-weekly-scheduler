...
var WeeklySchedulerItem = /** @class */ (function () {
    function WeeklySchedulerItem(config, item, endAdjusterService, fillEmptyWithDefaultService, overlapService, purgeDefaultService) {
        this.config = config;
        this.item = item;
        this.endAdjusterService = endAdjusterService;
...
var WeeklySchedulerItemFactory = /** @class */ (function () {
    function WeeklySchedulerItemFactory(dayMap, endAdjusterService, fillEmptyWithDefaultService, overlapService, purgeDefaultService) {
        this.dayMap = dayMap;
        this.endAdjusterService = endAdjusterService;
        this.fillEmptyWithDefaultService = fillEmptyWithDefaultService;
        this.overlapService = overlapService;
