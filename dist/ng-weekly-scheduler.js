    ...
    HourlyGridDirective.prototype.doGrid = function (scope, element, attrs, config) {
        ...
        for (var i = 0; i < tickcount; i++) {
            ...
            if (angular.isUndefined(attrs.noText)) {
                ...
                var numIntervalsInTick = 3600 / config.interval;
