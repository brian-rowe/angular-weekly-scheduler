...
var WeeklySchedulerController = /** @class */ (function () {
    function WeeklySchedulerController($element, $scope, $timeout, configurationService, conflictingOptionsService, fillEmptyWithDefaultService, groupService, dayMap, itemFactory, purgeDefaultService) {
        this.$element = $element;
        this.$scope = $scope;
