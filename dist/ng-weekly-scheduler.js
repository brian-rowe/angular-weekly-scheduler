...
var MultiSliderController = /** @class */ (function () {
    ...
    MultiSliderController.prototype.adjustGhost = function (event) {
        ...
        var existingLeftValue = this.pixelToVal(parseInt(this.ghostPosition.left, 10));
