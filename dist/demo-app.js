...
var DemoController_1 = __webpack_require__(103);
...
Object.defineProperty(exports, "__esModule", { value: true });
var DemoAdapter_1 = __webpack_require__(104);
var DemoItem_1 = __webpack_require__(105);
var DemoController = /** @class */ (function () {
    function DemoController($q, $scope) {
        this.$q = $q;
        this.$scope = $scope;
    }
        ...
        this.$scope.model = {
            options: {
                ...
                saveScheduler: function () {
                    _this.$scope.result = _this.$scope.adapter.getSnapshot();
                    return _this.$q.when(true);
                }
            }
        };
        this.$scope.adapter = new DemoAdapter_1.DemoAdapter([
            {
                day: 5 /* Saturday */,
                start: 3600,
                end: 7200,
    ...
    DemoController.$name = 'DemoController';
    DemoController.$inject = ['$q', '$scope'];
