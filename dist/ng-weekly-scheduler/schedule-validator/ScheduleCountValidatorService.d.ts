...
/** @internal */
export declare class ScheduleCountValidatorService implements ValidatorService {
    static $name: string;
    readonly error: ValidationError;
    validate(schedules: IWeeklySchedulerRange<any>[], config: IWeeklySchedulerConfig<any>): boolean;
    private validateExactCount(schedules, config);
    private validateMaxCount(schedules, config);
}
