...
var RestrictionExplanationsController = /** @class */ (function () {
    ...
    RestrictionExplanationsController.prototype.$doCheck = function () {
        this.violations = (_a = {},
            _a["fullCalendar" /* FullCalendar */] = angular.isDefined(this.schedulerCtrl.formController.$error.fullCalendar),
            _a["maxTimeSlot" /* MaxTimeSlot */] = angular.isDefined(this.schedulerCtrl.formController.$error.maxTimeSlot),
            _a["monoSchedule" /* MonoSchedule */] = angular.isDefined(this.schedulerCtrl.formController.$error.monoSchedule),
            _a);
        var _a;
    };
