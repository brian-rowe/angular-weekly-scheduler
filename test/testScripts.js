...
var MultiSliderController = /** @class */ (function () {
    ...
    MultiSliderController.prototype.adjustGhost = function () {
        ...
        if (this.item.day === 0) {
            if (ghostValues.left === ghostValues.right) {
                console.log(mouseValue);
                console.log(existingLeftValue);
                console.log(updatedLeftValue);
                console.log(updatedRightValue);
            }
        }
        this.setGhostValues({
