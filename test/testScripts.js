    ...
    function HandleDirective($document) {
        ...
        this.link = function (scope, element) {
            ...
            function mousemove(event) {
                var pageX = getTouches(event)[0].clientX;
                var delta = pageX - x;
