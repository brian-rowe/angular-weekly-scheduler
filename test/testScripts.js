...
var TimeRangeComponent = /** @class */ (function () {
    function TimeRangeComponent() {
        ...
        this.template = "{{ $ctrl.schedule.start | brWeeklySchedulerTimeOfDay }}-{{ $ctrl.schedule.end | brWeeklySchedulerTimeOfDay }}";
    }
