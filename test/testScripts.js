...
var MultiSliderController = /** @class */ (function () {
    ...
    MultiSliderController.prototype.addScheduleAndMerge = function (schedule) {
        var range = this.item.addSchedule(schedule);
