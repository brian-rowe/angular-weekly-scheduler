...
var MultiSliderController = /** @class */ (function () {
    ...
    MultiSliderController.prototype.getOverlapState = function (current, other) {
        var overlapState = this.overlapService.getOverlapState(this.config, current, other);
        return overlapState;
    };
