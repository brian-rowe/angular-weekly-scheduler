...
var MultiSliderController = /** @class */ (function () {
    ...
    MultiSliderController.prototype.commitGhost = function () {
        ...
        if (this.item.canAddSchedule()) {
            var schedule = this.getScheduleForAdd(this.ghostValues.left, this.ghostValues.right);
            this.openEditorForAdd(schedule).then(function (editedSchedule) {
                _this.item.addScheduleAndMerge(editedSchedule);
