...
var MultiSliderController = /** @class */ (function () {
    ...
    MultiSliderController.prototype.adjustGhost = function (event) {
        var val = this.getGhostLeftVal(event);
        // Lock left edge in place
        var updatedLeft = this.$hoverElement.css('left');
        // Make right edge adjust to new mouse position
        var updatedRight = this.getSlotRight(val, this.pixelToVal(event.pageX));
    ...
    MultiSliderController.prototype.getGhostLeftPixel = function (event) {
        ...
        var left = event.pageX - elementOffsetX - this.$hoverElement[0].clientWidth / 2;
        return left;
    };
