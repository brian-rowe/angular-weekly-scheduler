angular.module('demoApp', ['br.weeklyScheduler', 'ngMaterial'])
    ...
    function ($q, $scope, $timeout, $log, $mdDialog) {
        ...
        $scope.cancelDialog = function () { return $mdDialog.cancel(); };
        $scope.closeDialog = function () { return $mdDialog.hide(); };
