    ...
    function ($q, $scope, $timeout, $log) {
        ...
        $scope.model = {
            options: {
                ...
                monoSchedule: true,
                saveScheduler: function () { return $q.when(); }
            }
        };
